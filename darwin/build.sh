...
build_platform() {
    ...
    bash "${script_dir}/run_build.sh" third_party/llama.cpp $dev_team ${platform}
...
build_platform "OS64" "GZ5DFXJDC2"
build_platform "SIMULATORARM64" "GZ5DFXJDC2"
build_platform "SIMULATOR64" "GZ5DFXJDC2"
